...
png("./data/NBmycn_GNB_FC_images/NBmycn_GNB_graph_ras.png", width = 2800, height = 2800, units = "px", pointsize = 20, res="300")
...
p1 <- ggplot(e_df_lg, aes(x=mean, y=paste0(miriam.kegg.reaction, " (from: ", from_label, " - to: ",to_label, ")"), group=group)) + 
  ...
  theme(panel.grid.major.y = element_line(color = "lightgray",
                                          ...
                                          linetype = 1)) + xlab("")
ggsave(
  "NBmycn_GNB_FC_ras.png",
  plot = p1,
  device = "png",
  path = "./data/NBmycn_GNB_FC_images/",
  scale = 1,
  width = 2800,
  height = 1500,
  units = "px",
...
png("./data/NBmycn_GNB_FC_images/NBmycn_GNB_graph_ras_prob.png", width = 2800, height = 2800, units = "px", pointsize = 20, res="300")
par(omi=c(0,0,0,0), mgp=c(0,0,0),mar=c(0,0,0,0))
plot(mgraph_sub, layout=mylay, vertex.label.color= "black", vertex.label.family= "Arial")
dev.off()
```
...
png("./data/NBmycn_GNB_FC_images/NBmycn_GNB_graph_ras_prob_rec.png", width = 2800, height = 2800, units = "px", pointsize = 20, res="300")
par(omi=c(0,0,0,0), mgp=c(0,0,0),mar=c(0,0,0,0))
plot(mgraph_sub, layout=mylay, vertex.label.color= "black", vertex.label.family= "Arial")
dev.off()
```
...
ggsave(
  "NBmycn_GNB_FC_ras_prob_rec.png",
  plot = p3,
  device = "png",
  path = "./data/NBmycn_GNB_FC_images/",
  scale = 1,
...
png("./data/NBmycn_GNB_FC_images/NBmycn_GNB_graph_ras_prob_path.png", width = 2800, height = 2800, units = "px", pointsize = 20, res="300")
par(omi=c(0,0,0,0), mgp=c(0,0,0),mar=c(0,0,0,0))
plot(mgraph_sub, layout=mylay, vertex.label.color= "black", vertex.label.family= "Arial")
dev.off()
```
...
ggsave(
  "NBmycn_GNB_FC_ras_prob_path.png",
  plot = p4,
  device = "png",
  path = "./data/NBmycn_GNB_FC_images/",
  scale = 1,
